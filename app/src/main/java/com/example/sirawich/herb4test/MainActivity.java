...
import com.example.sirawich.herb4test.util.HelperView;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GestureDetector.OnGestureListener {
    ...
    private String[] tagLines = {
            "รวมสมุนไพรที่พบได้ทั่วไปและหายากและผู้ใช้สามารถค้นหาสมุนไพรโดยการพิมพ์ชื่อสมุนไพร",
            "ผู้ใช้สามารถค้นหาอาการปวดตามร่างกายได้",
            "เพื่อทดสอบความรู้ความเข้าใจเกี่ยวกับสมุนไพรผู้ใช้สามารถเล่นเกมส์เพื่อทบทวนความจำได้",
            "แอพพลิเคชันมีแพทย์สมุนไพรให้คำปรึกษาอยู่ตลอด", "รวมคำถามที่พบบ่อยและอีเมล์ืที่สามารถติดต่อเราได้"
    };
